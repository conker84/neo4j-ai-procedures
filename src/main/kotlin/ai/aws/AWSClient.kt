...
import ai.azure.AzureHttpClient
import ai.dto.AIMapResult
import ai.service.AI
...
class AWSClient(apiKey: String, apiSecret: String, private val log: Log): AI {
    ...
    override fun entities(data: Any, config: Map<String, Any?>): List<AIMapResult> {
        ...
        return allData.map { AIMapResult(AzureHttpClient.MAPPER.convertValue(it, Map::class.java) as Map<String, Any?>) }
    }
